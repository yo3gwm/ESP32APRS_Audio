...
#define PLL1200_NOT_LOCKED_TUNE 0.67f // was 0.50f — faster clock recovery at packet start
...
{
	if (AFSK_GetTxInhibit())
	{
		log_d("TX blocked: RF module AT command session active");
		return;
	}
	txTestState = TEST_DISABLED;
	setPtt(true); // PTT on
