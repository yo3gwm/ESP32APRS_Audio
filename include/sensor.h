...
#define PORT_CPU_TEMP 27

#define SENSOR_PORT_NUM 28
const char SENSOR_PORT[SENSOR_PORT_NUM][15] = {"UART0_CSV", "UART1_CSV", "ADC", "I2C_0","I2C_1","COUNTER_0","COUNTER_1","LOGIC","M701_Modbus","M702_Modbus","BME280_I2C0","BME280_I2C1","BMP280_I2C0","BMP280_I2C1","SI7021_I2C0","SI7021_I2C1","CCS811_I2C0","CCS811_I2C1","GNSS_NUM","GNSS_HDOP","SHTxx_I2C0","SHTxx_I2C1","SYS_BAT","PZEM","MODBUS_16Bit","MODBUS_32Bit","DS1820_1Wire","CPU_TEMP"};

#define SENSOR_NAME_NUM 29
const char SENSOR_NAME[SENSOR_NAME_NUM][20] = {"NONE", "CO2", "CH2O", "TVOC","PM2.5","PM10","TEMPERATURE","HUMIDITY","PRESSURE","WIND_SPD","WIND_DIR","RAIN","LUMINOSITY","SOIL_TEMP","SOIL_HUM","WATER_TEMP","WATER_TDS","WATER_LEVEL","WATER_FLOW","VOLTAGE","CURRENT","POWER","ENERGY","FREQ","PF","SAT_NUM","SAT_HDOP","BATTERY_VOLT","BATTERY_PERCENT"};
